        ...
        children: [
            {
                label: 'Home Page',
                children: [
                    { label: 'Hero Section', href: route('admin.hero-section'), slug: 'hero-section' },
                    { label: 'Services Section', href: route('admin.service-section.index'), slug: 'service-section' },
                    { label: 'About Section', href: '#', slug: 'about-section' },
                    { label: 'Contact Section', href: '#', slug: 'contact-section' },
                ],
            },
        ],
    },
...
export function AdminSidebar({
    ...
    return (
        ...
        >
            <h2 className="p-2 text-lg font-bold text-blue-600">BathPro Remodeling</h2>
            <nav className="space-y-1 overflow-y-auto">
                                    ...
                                    <div key={page.label}>
                                        {'children' in page && page.children ? (
                                                ...
                                                >
                                                    ...
                                                    <ChevronDown
                                                        className={cn(
                                                            ...
                                                            openPages[page.label] && 'rotate-180',
                                                        )}
                                                    />
                                                </button>
                                                        ...
                                                        {page.children.map((sub) => (
                                                            <Link
                                                                ...
                                                                className={cn(
                                                                    ...
                                                                    activeSlug === sub.slug || url === sub.href
                                            ...
                                            <Link
                                                ...
                                                className={cn(
                                                    'flex w-full items-center rounded-md px-2 py-1.5 text-sm transition-colors hover:bg-accent hover:text-accent-foreground',
                                                    activeSlug === page.slug || url === page.href
                                                        ? 'font-medium text-primary'
                                                        : 'text-muted-foreground',
                                                )}
                                            >
                ...
                >
                    ...
                    {!isCollapsed && <span className="flex-1 truncate">Estimates</span>}
                </Link>
                <Link
                    href="#"
                    className="group relative flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-muted-foreground transition-all duration-200 hover:bg-accent hover:text-accent-foreground"
                >
                    ...
                    {!isCollapsed && <span className="flex-1 truncate">Contact</span>}
                </Link>
                <Link
                    href="#"
                    className="group relative flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-muted-foreground transition-all duration-200 hover:bg-accent hover:text-accent-foreground"
                >
                    ...
                    {!isCollapsed && <span className="flex-1 truncate">Site Settings</span>}
                </Link>
            </nav>
        </aside>
    );
