            ...
            <section id="how-it-works" className="lg:py-20 py-10 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-8">
                    ...
                    <div className="relative grid grid-cols-1 md:grid-cols-3 gap-10">
                        ...
                        <div className="text-center relative"><div className="step-circle text-gray-900 font-bold text-2xl font-inter ">1</div><h3 className="text-[#0A0A0A] mb-2 font-inter font-normal text-2xl">Request Free Estimate</h3><p className="text-base font-inter font-normal text-gray-500 leading-relaxed">Submit photos and select your options online in just minutes.</p></div>
                        <div className="text-center relative"><div className="step-circle text-gray font-bold text-2xl font-inter">2</div><h3 className="text-[#0A0A0A] mb-2 font-inter font-normal text-2xl">Get Your Quote</h3><p className="text-base font-inter font-normal text-gray-500 leading-relaxed">Receive a detailed estimate via text message within 24 hours.</p></div>
                        <div className="text-center relative"><div className="step-circle text-gray-900 font-bold text-2xl font-inter">3</div><h3 className="text-[#0A0A0A] mb-2 font-inter font-normal text-2xl">Schedule &amp; Complete</h3><p className="text-base font-inter font-normal text-gray-500 leading-relaxed">Approve the estimate and we'll schedule your project.</p></div>
                    </div>
